...
ASSETS_PATH = Path(__file__).parent.parent / "assets_ko"
...
print(f"Missing modern Hangul syllables: {len(missing_hangul)}")
...
all_new_chars = set(missing_hangul) | set(
    extra_chars) | new_chars_from_sentences
